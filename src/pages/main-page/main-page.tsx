...
const MAIN_SECTION_WIDTH: number = 50;

export const MainPage = () => {
  useEffect(() => {}, []);
  return (
    <div className={styles.container}>
      <Section type='primary' widthPercentage={MAIN_SECTION_WIDTH}>
        <Recommended />
      </Section>
      <Section type='secondary' widthPercentage={100 - MAIN_SECTION_WIDTH}>
        <FavouritesMain />
      </Section>
    </div>
  );
